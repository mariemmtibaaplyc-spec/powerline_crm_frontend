import { BellRing, Phone, PhoneCall } from "lucide-react";
...
export type AgentReminderStatus = ReminderStatus;
export type AgentReminderItem = Reminder & { prospect: ProspectSheet };
...
export function AppointmentsTable({
  ...
  items: readonly AgentReminderItem[];
  today: string;
  onCallReminder?: (item: AgentReminderItem) => void;
}) {
        ...
        <div className="flex min-h-[240px] flex-col items-center justify-center gap-4 px-6 py-12 text-center">
          ...
          <div className="space-y-2">
            ...
            <p className="max-w-md text-sm leading-6 text-[#607287]">
              Les rappels qualifies reviendront ici avec leur heure prevue, la
              note agent et l'action de reprise selon la date selectionnee.
            </p>
          </div>
        </div>
      </TableWrapper>
        ...
        <Table className="min-w-[1040px]">
          <thead className="bg-[linear-gradient(180deg,#fbfdff_0%,#f5f9fd_100%)]">
            <tr>
              ...
              <TableHeadCell>Note de rappel</TableHeadCell>
              <TableHeadCell className="whitespace-nowrap">Etat</TableHeadCell>
                ...
                >
                  ...
                  <TableCell className="align-top">
                    <div className="space-y-1">
                      ...
                      <p className="text-sm text-[#607287]">
                        Prospect a relancer sur le creneau planifie.
                      </p>
                    </div>
                  </TableCell>
                  ...
                  <TableCell className="whitespace-nowrap text-right align-top">
                    <button
                      ...
                      aria-label={`Appeler ${item.clientName}`}
                    >
