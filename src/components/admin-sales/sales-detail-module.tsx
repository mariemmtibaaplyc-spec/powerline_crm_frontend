...
export function SalesDetailModule({
  ...
  return (
    <section className="space-y-6">
      ...
      {error ? (
        <Card className="border border-[#f2cbd5] bg-[#fff7fa] shadow-[0_18px_42px_rgba(20,32,53,0.04)]">
          <CardContent className="pt-6 text-sm text-[#9b3554]">{error}</CardContent>
        </Card>
      ) : null}
      ...
      {appointment ? (
            ...
            <CardContent className="space-y-5 pt-6">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                {[
                  ...
                  ["Reference contact", appointment.contactLabel],
                  ["Lead", appointment.leadLabel],
                ].map(([label, value]) => (
                  <div
                    key={label}
        ...
        <Card className="border border-[#dce6f0] bg-white shadow-[0_18px_42px_rgba(20,32,53,0.04)]">
          <CardContent className="pt-6 text-sm text-[#607287]">
